...
"""
    Usage: python3 PyTorch/InceptionV3_inference/pytorch_inceptionV3_batch_inference.py
...
print("[INFO] InceptionV3 model is loading ..")
...
dataloader = MyDataLoader(images_path, batch_size, width=299, height=299)
