...
"""
    Usage: python3 PyTorch/ResNet50_inference/pytorch_inceptionV3_batch_inference.py
...
print("[INFO] ResNet50 model is loading ..")
model = models.resnet50(weights=ResNet50_Weights.DEFAULT).to(device)
# Ref: https://pytorch.org/vision/main/models/generated/torchvision.models.resnet50.html#torchvision.models
# .ResNet50_Weights
model.eval()
